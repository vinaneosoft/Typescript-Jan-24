let salaryArray:Array<number>;
salaryArray=new Array<number>(); // primitives as well as wrappers allowed

let salaries=new Array<number>();
...
let empNames:Array<string>=["Zahida","Kripa","krishna","Mayur",'Padma'];
